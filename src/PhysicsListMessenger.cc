...
:G4UImessenger(),fPhysicsList(phys),
 ...
 fListCmd(0)
{
  fPhysDir = new G4UIdirectory("/protonPB/phys/");
  fPhysDir->SetGuidance("physics list commands");
   
  fGammaCutCmd = new G4UIcmdWithADoubleAndUnit("/protonPB/phys/setGCut",this);  
  ...
  fElectCutCmd = new G4UIcmdWithADoubleAndUnit("/protonPB/phys/setECut",this);  
  ...
  fProtoCutCmd = new G4UIcmdWithADoubleAndUnit("/protonPB/phys/setPCut",this);  
  ...
  fAllCutCmd = new G4UIcmdWithADoubleAndUnit("/protonPB/phys/setCuts",this);  
  ...
  fListCmd = new G4UIcmdWithAString("/protonPB/phys/addPhysics",this);  
