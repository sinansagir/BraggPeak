...
:G4UImessenger(),fPhysicsList(phys),
 ...
 fListCmd(0)
{
  fPhysDir = new G4UIdirectory("/protonGB/phys/");
  fPhysDir->SetGuidance("physics list commands");
   
  fGammaCutCmd = new G4UIcmdWithADoubleAndUnit("/protonGB/phys/setGCut",this);  
  ...
  fElectCutCmd = new G4UIcmdWithADoubleAndUnit("/protonGB/phys/setECut",this);  
  ...
  fProtoCutCmd = new G4UIcmdWithADoubleAndUnit("/protonGB/phys/setPCut",this);  
  ...
  fAllCutCmd = new G4UIcmdWithADoubleAndUnit("/protonGB/phys/setCuts",this);  
  ...
  fListCmd = new G4UIcmdWithAString("/protonGB/phys/addPhysics",this);  
